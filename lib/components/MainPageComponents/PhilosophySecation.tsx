  ...
  return (
    <section ref={philosophyElement} className="overflow-hidden">
      <div className={`flex flex-col items-center mt-20 md:mt-28 `}>
        ...
        <animated.div style={philosophyAnimate(elementInView, "100%")}>
          <div
            className="font-bold mt-5 sm:mt-14 text-xl md:text-2xl xl:text-4xl tracking-wide md:tracking-wider text-center transition-all ease-in-out duration-300"
            role="heading"
            aria-level={3}
          >
        ...
        <animated.div
          ...
          role="region"
          aria-labelledby="philosophy-description"
        >
          <div
            className="flex flex-col  pl-5 pr-5 items-center  w-full "
