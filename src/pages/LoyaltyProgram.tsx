      ...
      <main className="pb-20">
        <section className="w-full flex justify-center mt-10 mb-10">
          <div className="w-8/12 ">
            Program lojalnosciowy dam dam damaaam dam damda damdaad Program
            lojalnosciowy dam dam damaaam dam damda damdaad Program
            lojalnosciowy dam dam damaaam dam damda damdaad Program
            lojalnosciowy dam dam damaaam dam damda damdaad Program
            lojalnosciowy dam dam damaaam dam damda damdaad Program
            lojalnosciowy dam dam damaaam dam damda damdaadDF{" "}
          </div>
        </section>
        <section className="flex pl-10 pr-10 mt-20">
          <div className="w-7/12">
            <span className="flex justify-center mb-5 text-2xl font-semibold color-pink">
            ...
            <div className="text-justify flex flex-col">
              ...
              <div>
                ...
                <ul className="loyalty-program-benefits">
                  <li className="text-lg flex items-center pl-2 mt-2 list-icon">
                    <svg
