      ...
      <main className="pl-5 pr-10">
        <article>
          ...
          <div className="mt-10 flex">
            <div className="about-img-holder w-5/12 ml-5">
              <img
                alt="loading err"
            ...
            <div className="w-7/12 pl-5 text-justify">
              <div>
                {" "}
                blaaaa blaa blaaaaa bla blaaaa bla bla blaaaa blaa blaaaaa bla
                blaaaa bla bla blaaaa blaa blaaaaa bla blaaaabla bla blaaaa blaa
          ...
          <div className="mt-10 flex">
            <div className="w-6/12 pl-5 text-justify">
              <div>Psi fryzjer</div>
              <div>opis</div>
              <div>
                <ul>
                  <li>Zaufana opieka</li>
                  <li>Profesjonalna pielęgnacja</li>
                  <li>Indywidualne podejście</li>
                  <li>Najlepsze kosmetyki</li>
                </ul>
              </div>
              <div>
                <button>Zapisz się na wizytę online</button>
              </div>
            </div>
            <div className="about-img-holder w-6/12 ml-5">
              <img
                alt="loading err"
                className="about-img w-full h-full"
                src={p1}
        ...
        <article className="w-full flex justify-center">
          <div className="mt-12 ">
            ...
            <div className="flex justify-center mt-5">
              ...
              <div className="contact-social rounded-full ml-5 cursor-pointer p-[11px] ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="45px"
