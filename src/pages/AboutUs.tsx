      ...
      <main className="pl-5 pr-10">
        <article>
          ...
          <div className="mt-5 md:mt-10 flex flex-col md:flex-row">
            <div className="about-img-holder md:w-5/12 w-full ml-0 md:ml-5 ">
              <img
                alt="loading err"
                className="about-img w-full h-full"
                src={p1}
              />
            </div>
          ...
          <div className="mt-10 flex flex-col md:flex-row">
            <div className="w-full md:w-6/12 pl-5 text-justify">
            ...
            <div className="about-img-holder w-full md:w-6/12 ml-0 md:ml-5">
              <img
                alt="loading err"
                className="about-img w-full h-full"
                src={p1}
          ...
          <div className="mt-12 ">
            ...
            <div className="flex justify-center mt-5 flex-col md:flex-row items-center md:items-start ">
              <div className="flex  social-holder ">
                <div className=" rounded-full cursor-pointer p-[10px] bg-Tick">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width="45px"
                ...
                <div className=" rounded-full ml-5 cursor-pointer p-[10px] bg-insta">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width="45px"
              ...
              <div className="flex  social-holder mt-4 md:mt-0">
                ...
                <div className="  rounded-full ml-5 cursor-pointer p-[10px] bg-maps">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="48px"
                    viewBox="0 -960 960 960"
