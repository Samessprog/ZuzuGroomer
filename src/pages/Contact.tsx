  ...
  return (
    <div>
      <div className="relative">
        ...
        />
        <span className="absolute text-6xl fancy-text tracking-wide contact-info-text z-1">
          <i>Kontakt</i>
        </span>
      </div>
      <main>
            ...
            <div className="flex flex-col w-full xl:w-7/12 items-center xl:items-start">
              ...
              <div className="mt-5 w-full">
                ...
                <div className="flex justify-center xl:justify-between  xl:w-4/12 mt-7">
                  <div className="contact-social rounded-full">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="45px"
                  ...
                  <div className="contact-social rounded-full ml-5">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="45px"
        ...
        <section>
          <iframe
            title="google-map"
            className="w-full mt-20 map-container mb-5"
