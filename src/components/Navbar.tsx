    ...
    <nav className="flex justify-center sticky top-0 z-10 opacity-95 bg-white border-b border-gray-300">
      <div className="flex w-full items-center flex-wrap mb-0 sm:mb-4 mt-7 max-w-screen-2xl">
        ...
        >
          ...
          >
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">O nas</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">Usługi</a>
            </li>
            <li
              className={`menu-navbar-item  text-lg  cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">Psi Behawiorysta</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">Program lojalnościowy</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">Galeria</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : " "}`}
            >
              <a className="item-context relative">Cennik</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-3 justify-center items-center open" : ""}`}
            >
              <a className="item-context relative">Kontakt</a>
            </li>
            <li
              className={`menu-navbar-item text-lg cursor-pointer mr-5 ${isMenuOpen ? "flex flex-col mb-5 justify-center items-center open" : ""}`}
            >
              <a className="item-context relative">Regulamin</a>
            </li>
          </ul>
        </div>
        <div className="w-2/12 flex navbar-icons-holder order-3 border-l border-gray-300 pl-7 pr-1 sm:pr-0 md:pr-7">
          <div className="flex flex-col md:flex-row">
            <svg
              ...
              height="24px"
              id="facebook-icon"
              className="mb-3 md:mb-0 mr-3.5 cursor-pointer"
            >
              {" "}
            ...
            <svg
              ...
              height="26px"
              id="instagram-icon"
              className="mb-3 md:mb-0 mr-3.5 cursor-pointer transition-fill easy-in-out duration-300"
            >
              {" "}
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <svg
              ...
              height="26px"
              id="tikTok-icon "
              className="cursor-pointer transition-fill easy-in-out duration-300"
            >
