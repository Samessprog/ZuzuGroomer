  ...
  return (
    <footer className="text-white bg-[#191919]">
      <div className="flex w-full pl-10 pr-10 pt-20 pb-20 footer-container flex-col xl:flex-row justify-center xl:justify-start items-center xl:items-start">
        <div className="flex flex-col text-zinc-500 w-full xl:w-4/12 items-center xl:items-start">
          <div className="flex justify-center">
            <img
              ...
              alt="loading footer img error"
            />
          </div>
          <label className="flex mt-10">
            <label className="mb-3 w-12/12 flex flex-col items-center xl:items-start">
              <label className="flex items-center">
                <svg
                  ...
                  width="20px"
                  height="20px"
                  className="mr-2 fill-orange-600"
                >
              ...
              <label className="mt-1">ul.NIEZNANA 10 lok 10</label>
              <label className="mt-1">41-400 Mysłowice</label>
            </label>
          </label>
          <label className="mt-1 lg:mt-7 mb-2">NIP: 6432347531</label>
          <label className="mt-1 lg:mt-2 mb-2">REGON: 145434343</label>
          <label className="mt-3 lg:mt-7 mb-2">
        ...
        <div className="flex justify-center items-center xl:items-start mt-3 xl:mt-0 w-full xl:w-3/12">
          <div className="flex flex-col menu text-lg text-zinc-500 items-center xl:items-start">
            <label className="mb-3 font-semibold text-lg text-white">
              Menu:
            </label>
            <a className="mb-2 hover:text-white cursor-pointer transition ease-in-out duration-300 ">
              Usługi
            </a>
            <a className="mb-2 hover:text-white cursor-pointer transition ease-in-out duration-300">
              Cennik
        ...
        <div className="flex flex-col items-center text-lg text-zinc-500 w-full xl:w-2/12 mt-3 xl:mt-0">
          <div className="flex flex-col items-center xl:items-start mt-3 xl:mt-0">
            ...
            <label className="mb-2">Pon - Pt: 10:00 - 18:00</label>
            <label className="mb-2">Sobota: 10:00 - 14:00</label>
            <label className="mb-2">Niedziela: Nieczynne</label>
            <div className="flex items-center mt-3 ">
              ...
              <label className="mb-2 mt-3 xl:mt-0">823421821</label>
            </div>
            <div className="flex items-center">
              <svg
                ...
                viewBox="0 -960 960 960"
                width="22"
                className="fill-orange-600 mr-2"
              >
                <path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280L160-640v400h640v-400L480-440Zm0-80 320-200H160l320 200ZM160-640v-80 480-400Z" />
              </svg>
              <label className="mb-2">ZuzuHasu@12.inter.com</label>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col w-full items-center border-t border-gray-500 pb-2 text-zinc-500">
        <label className="mt-2"> &reg; ZuzuHasu. All rights reserved.</label>
        <label>
          realizacja
          <a
            target="_blank"
            className="ml-2 text-orange-500 hover:border-b-[2px] border-orange-500"
