...
const Footer: React.FC = () => {
  return (
    <footer className="text-white bg-[#191919] ">
      <div className="flex w-full pl-10 pr-10 pt-20 pb-20 footer-container flex-col xl:flex-row justify-center xl:justify-start items-center xl:items-start">
        <div className="flex flex-col text-[#AAAAB1] w-full xl:w-4/12 items-center xl:items-start ">
          <a
            ...
            rel="noreferrer"
          >
            <label className="flex mt-10 xl:mt-1 cursor-pointer">
              <label className="mb-3 w-12/12 flex flex-col items-center xl:items-start text-sm cursor-pointer">
                <label className="flex items-center c cursor-pointer">
                  <svg
                  ...
                  Salon Psiej Piękności zuzu hasu Zuzanna Hassa
                </label>
                <label className="mt-1 cursor-pointer">
                  ul.NIEZNANA 10 lok 10
                </label>
                <label className="mt-1 cursor-pointer">41-400 Mysłowice</label>
              </label>
            </label>
          </a>
          <label className="mt-1 lg:mt-7 mb-2 text-sm">NIP: 6432347531</label>
          <label className="mt-1 lg:mt-2 mb-2 text-sm">REGON: 145434343</label>
          <label className="mt-3 lg:mt-7 mb-2 text-sm">
            Prosze o kontakt telefoniczny lub mailowy w celu umówienia wizyty
          </label>
        </div>
        <div className="flex justify-center items-center xl:items-start mt-3 xl:mt-0 w-full xl:w-3/12">
          <div className="flex flex-col menu text-lg text-[#AAAAB1] items-center xl:items-start">
        ...
        <div className="flex flex-col items-center text-lg text-[#AAAAB1] w-full xl:w-2/12 mt-3 xl:mt-0">
          <div className="flex flex-col items-center xl:items-start mt-3 xl:mt-0 ">
            <label className="mb-3 font-semibold text-white ">Zapraszamy</label>
            <label className="mb-2 text-sm">Pon - Pt: 10:00 - 18:00</label>
            <label className="mb-2 text-sm">Sobota: 10:00 - 14:00</label>
            ...
            <div className="flex items-center mt-3 ">
              ...
              <label className="mb-2 mt-3 xl:mt-0 text-sm">823421821</label>
            </div>
            <div className="flex items-center">
              ...
              <label className="mb-2 text-sm">ZuzuHasu@12.inter.com</label>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col w-full items-center border-t border-gray-500 pb-2 text-[#AAAAB1] text-[13px]">
        <label className="mt-2"> &reg; ZuzuHasu. All rights reserved.</label>
        <label>
          realizacja
          <a
            target="_blank"
