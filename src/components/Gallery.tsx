  ...
  return (
    <section>
      <div className="flex flex-col items-center gallery-header">
        ...
        <div className="mt-10 md:text-lg text-sm w-10/12 text-center md:w-full">Zobacz jak Twój pupil będzie wyglądać po kompleksowej pielęgnacji w ZUZU HASU</div>
      </div>
