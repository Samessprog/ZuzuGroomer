      ...
      <div className="flex w-full pl-10 pr-10 pt-20 pb-20 footer-container flex-col xl:flex-row justify-center xl:justify-start items-center xl:items-start">
        ...
        <div className="flex flex-col items-center text-lg text-[#AAAAB1] w-full xl:w-2/12 mt-3 xl:mt-0">
          <div className="flex flex-col items-center xl:items-start mt-3 xl:mt-0 ">
            ...
            <label className="mb-2 text-sm">Pon: 11:00 - 19:00</label>
            <label className="mb-2 text-sm">Wt: 9:00 - 17:00</label>
            <label className="mb-2 text-sm">Śr: 9:00 - 17:00</label>
            <label className="mb-2 text-sm">Czw: 9:00 - 17:00</label>
            ...
            <div className="flex items-center mt-3 ">
              ...
              <label className="mb-2 mt-3 xl:mt-0 text-sm">512785857</label>
            </div>
            <div className="flex items-center">
              ...
              <label className="mb-2 text-sm">zuzanna.hassa@op.pl</label>
            </div>
          </div>
        </div>
