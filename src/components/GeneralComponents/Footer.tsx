    ...
    >
      <div className="flex w-full pl-10 pr-10 pt-20 pb-20 footer-container flex-col xl:flex-row justify-center xl:justify-start items-center xl:items-start">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          >
            <a href="#" target="_blank" aria-label="Facebook" role="link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="30px"
            ...
            <a href="#" target="_blank" aria-label="Instagram" role="link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="30px"
            ...
            <a href="#" target="_blank" aria-label="GoogleMaps" role="link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                width="30px"
