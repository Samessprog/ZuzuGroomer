...
import TwentyTwentyAnimation from "./TwentyTwentyAnimation";
...
const PetCareSection: React.FC = () => {
  ...
  return (
    <section 
      className="w-full flex mb-20 overflow-hidden mt-20 items-center flex-col xl:flex-row"
      ref={ref}
    >
      <animated.div
      ...
      >
        <label className="header-text-content mb-5 xl:mb-0 md:text-6xl tracking-wider transition-all ease-in-out duration-200 text-5xl">
        ...
        <button className="special-button font-semibold flex items-center text-white rounded-3xl pl-7 pr-5 p-3 mt-8 xl:mt-0 transform hover:transform-x-0 transition-all ease-out duration-200">
      ...
      <div className="xl:mt-6 flex justify-center flex-col TwentyTwenty mt-10 pl-5 pr-5 md:pl-0 md-mr-0 w-full sm:w-10/12 md:w-9/12 xl:w-5/12 transition-all ease-in-out duration-200 ">
        ...
        <div className="Twentytwenty-container xl:w-10/12 relative mb-2 overflow-hidden transition-all ease-in-out duration-200 text-center w-full">
          ...
          <div className="absolute twentyTwenty-description left-0 flex justify-between w-full opacity-0 transform-all ease-in-out duration-200 text-base bottom-2">
            <div className="twentyTwenty-description-item pl-4 pr-4 pt-1.5 pb1.5">Przed zmianą</div>
            <div className="twentyTwenty-description-item pl-4 pr-4 pt-1.5 pb1.">Po zmianie</div>
          </div>
        </div>
      </div>
    </section>
